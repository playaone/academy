...
def test_service_creates_project():
...
def test_service_rejects_invalid_titles(title):
    repository = FakeProjectRepository()
    service = ProjectService(repository)
...
def test_service_rejects_duplicate_title():
    repository = FakeProjectRepository()
...
def test_service_raises_error_for_missing_project():
    repository = FakeProjectRepository()
    service = ProjectService(repository)
...
def test_service_raises_error_for_invalid_description(description):
    repository = FakeProjectRepository()
    service = ProjectService(repository)
...
def test_service_update_project_successful():
    repository = FakeProjectRepository()
    service = ProjectService(repository)
...
def test_service_detetion_successful():
    repository = FakeProjectRepository()
    service = ProjectService(repository)
